...
public class ItemController {
    ...
    public String itemForm(@ModelAttribute ItemFormDto itemFormDto, Model model) {
    ...
    public String itemNew(@Valid ItemFormDto itemFormDto, BindingResult bindingResult,
        ...
        if (itemImgFileList.get(0).isEmpty() && itemFormDto.getId() == null) {
            model.addAttribute("errorMessage", "첫번째 상품 이미지는 핅수 입력 값 입니다.");
            return "item/itemForm";
        }
    ...
    public String itemManage(ItemSearchDto itemSearchDto, @PathVariable Optional<Integer> page,
            Model model) {
